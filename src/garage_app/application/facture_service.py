...
class FactureService:
    ...
    def generer_facture(
        self, session: UserSession, dossier_id: uuid.UUID, taux_tva: Decimal = Decimal("20")
    ) -> Facture:
